...
urlpatterns = [
    ...
    path("sale/<uuid:sale_id>/", views.pos_sale_detail, name="sale_detail"),
    path("session/<uuid:session_id>/close/", views.pos_session_close, name="session_close"),
    ...
    path("receipt/<uuid:sale_id>/download/", views.pos_receipt_download, name="receipt_download"),
